...
class CRF(nn.Module):
    ...
    def _forward_alg(self, feats, mask):
        ...
        #print("feats_size",feats.size())
        #print("transitions",self.transitions.size())
        #print("expaned",ins_num,tag_size,tag_size)
        ...
        for idx, cur_values in seq_iter:
            ...
            #print("dfdf",type(mask_idx))
            #print("fdsf",mask_idx.size())
            #print("fdsfa",mask_idx)
            #print("cur_partition",cur_partition)
